...
BASE_URL7 = os.getenv("BASE_URL7")
DISCORD_WEBHOOK_URL = os.getenv("DISCORD_WEBHOOK_URL_GLOBAL_CHANNELS")
...
# JSON ჩატვირთვა
with open("streamsGlobal.json", "r", encoding="utf-8") as f:
...
print(f"სულ {len(streams)} სტრიმია")
